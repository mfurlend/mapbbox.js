...
const vp = bounds.length > 0 ? geoViewport.viewport(bounds, size) : {zoom, center};
const mapbox_token = fs.readFileSync(__dirname + '/mapbox_token', 'utf8');
const mapbox_url_template = fs.readFileSync(__dirname + '/mapbox_url_template', 'utf8') || 'https://api.mapbox.com/v4/mapbox.emerald/<lng>,<lat>,<zoom>/<width>x<height>.png?access_token=<token>';
